...
public class ExtraTest extends AbstractParent {
	...
	public void testNeliojuuri2() {
		...
		assertEquals(Math.sqrt(2), laskin.annaTulos(), DELTA, "Neliöjuuri laskettu väärin");
	}

	@Test
	@DisplayName("Testaa negatiivinen neliöjuuri")
	public void testNeliojuuriNegat() {
		Exception exception = assertThrows(ArithmeticException.class, () -> laskin.neliojuuri(-1));
